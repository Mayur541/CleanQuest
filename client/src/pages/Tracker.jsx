...
function Tracker() {
  ...
  const getStepClass = (stepStatus) => {
    ...
    // If completed or current, use primary color
        ...
        <div className="w-full max-w-3xl bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl border border-green-50 dark:border-gray-700 animate-fade-in-up transition-colors duration-300">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-center">
              {/* --- FIX: ADDED 'dark:text-gray-200' HERE --- */}
              <ul className="steps steps-vertical lg:steps-horizontal w-full dark:text-gray-200">
              ...
              {complaint.status === 'Resolved' && (
                <div className="mt-4 text-center animate-bounce">
                  ...
                  <p className="text-green-600 dark:text-green-400 font-bold mt-2">Thank you for making our city cleaner!</p>
                </div>
              )}
            </div>
          </div>
