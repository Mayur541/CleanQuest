...
>>>>>>> 16d08778f741fe64ed7a7dd8163dd6fdd294cc97
    };
...
=======
                 ...
                 <NavDropdown 
                   label="Register" 
                   items={[
                     { label: "User", to: "/signup/user" },
                     { label: "Admin", to: "/signup/admin" }
                   ]} 
                 />
                 <NavDropdown 
                   label="Login 🔒" 
                   items={[
                     { label: "User", to: "/login/user" },
...
=======
            ...
            <div className="pl-2 space-y-2">
               <p className="text-xs text-gray-400 font-bold uppercase mt-2">Register</p>
               <Link to="/signup/user" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300">User Signup</Link>
               <Link to="/signup/admin" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300">Admin Signup</Link>
               
               <p className="text-xs text-gray-400 font-bold uppercase mt-3">Login</p>
               <Link to="/login/user" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300">User Login</Link>
               <Link to="/login/admin" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300">Admin Login</Link>
>>>>>>> 16d08778f741fe64ed7a7dd8163dd6fdd294cc97
            </div>
          )}
        </div>
    ...
    return (
      <div className="min-h-screen bg-green-50 dark:bg-gray-900 flex items-center justify-center p-4 transition-colors duration-300">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl max-w-lg w-full text-center border-t-4 border-green-500 animate-fade-in-up">
          ...
          {email && <div className="mb-6 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 px-4 py-2 rounded-lg text-sm border border-blue-100 dark:border-blue-800 flex items-center justify-center gap-2"><span>📧</span><span>We'll notify <strong>{email}</strong> upon resolution.</span></div>}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input type="email" placeholder="name@example.com" className="w-full px-4 py-3 bg-blue-50 dark:bg-gray-800 dark:text-white rounded-lg border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-green-500 outline-none transition" value={email} onChange={(e) => setEmail(e.target.value)} disabled={loading} />
