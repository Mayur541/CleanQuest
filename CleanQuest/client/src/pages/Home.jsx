      ...
      <div className="min-h-screen bg-green-50 flex items-center justify-center p-4 font-sans">
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-lg w-full text-center border-t-4 border-green-500 animate-fade-in-up">
          ...
          <div className="bg-gray-100 p-4 rounded-lg mb-6 border border-gray-200">
            ...
            <p className="text-xl font-mono font-bold text-green-700 select-all">
              {submittedId}
            </p>
          ...
          <div className="flex gap-4 justify-center">
            <Link
              to="/tracker"
              className="bg-blue-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-blue-700 transition shadow flex items-center gap-2"
            >
              Track Now 🚀
            </Link>
            <button
      ...
      <section className="bg-green-50 text-center pt-20 pb-32 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mt-6 mb-6">
            Make Your City <span className="text-green-600">Cleaner</span>,
            Together.
          </h1>
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link
              to="/tracker"
              className="bg-white text-gray-700 px-8 py-3 rounded-lg font-bold hover:bg-gray-50 transition shadow border border-gray-200"
            >
              Track Issue
            </Link>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div
                  className={`border-2 border-dashed border-gray-300 rounded-lg p-4 h-full flex flex-col justify-center items-center transition ${
