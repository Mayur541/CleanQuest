...
// --- INTERNAL NAVBAR COMPONENT (With Theme Toggle) ---
const Navbar = () => {
  ...
  // Slider Component for Navbar
  const ThemeToggleSlider = () => (
    <div
      onClick={toggleTheme}
      className="relative w-14 h-7 flex items-center cursor-pointer bg-gray-200 dark:bg-gray-700 rounded-full p-1 transition-colors duration-300 shadow-inner"
    >
      <div className="absolute left-1.5 text-[10px]">☀️</div>
      <div className="absolute right-1.5 text-[10px]">🌙</div>
      <div
        className={`bg-white dark:bg-gray-800 w-5 h-5 rounded-full shadow-md transform transition-transform duration-300 z-10 ${
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 shadow-sm sticky top-0 z-50 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          >
            ...
            <span className="font-bold text-xl tracking-tight text-green-800 dark:text-green-400">
              CleanQuest
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {isAuth ? (
              <div className="flex items-center gap-3">
                <Link
                  to="/admin"
                  className="text-sm font-bold text-green-700 dark:text-green-400 hover:text-green-900"
                >
                  Dashboard
                </Link>
                <button
                  onClick={handleLogout}
                  className="px-3 py-2 rounded text-sm font-medium text-red-600 border border-red-200 hover:bg-red-50 dark:hover:bg-red-900/20"
                >
                  Logout
                </button>
              </div>
              ...
              <div className="flex items-center gap-2">
                <Link
                  to="/signup"
                  className="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-green-600 px-2"
                >
                  Register
                </Link>
                <Link
                  to="/login"
                  className="px-4 py-2 rounded-md text-sm font-bold text-white bg-green-900 hover:bg-green-800 shadow-sm"
                >
                  Login 🔒
                </Link>
              </div>
          ...
          <div className="md:hidden flex items-center gap-4">
            ...
            <button
              ...
              className="text-gray-600 dark:text-gray-300 hover:text-green-600 focus:outline-none"
            >
              <svg
                className="h-6 w-6"
                fill="none"
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 px-2 pt-2 pb-3 space-y-1 shadow-lg">
          <Link
            to="/"
            onClick={() => setIsOpen(false)}
          ...
          {isAuth ? (
            <>
              <Link
                to="/admin"
                onClick={() => setIsOpen(false)}
                className="block px-3 py-2 rounded-md text-base font-medium text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-900/20"
              >
                Dashboard
              </Link>
              <button
...
function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const existingHistory = JSON.parse(
        localStorage.getItem("myCleanQuestReports") || "[]"
      );
      localStorage.setItem(
        "myCleanQuestReports",
        JSON.stringify([newReport, ...existingHistory])
      );
      ...
      setLocation(null);
      setImage("");
      // Don't clear email so they can see they entered it
    } catch (error) {
      console.error(error);
    ...
    return (
      <div className="min-h-screen bg-green-50 dark:bg-gray-900 flex items-center justify-center p-4 transition-colors duration-300">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl max-w-lg w-full text-center border-t-4 border-green-500 animate-fade-in-up">
          ...
          {/* --- 3. RESTORED SUCCESS MESSAGE --- */}
          {email && (
            <div className="mb-6 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 px-4 py-2 rounded-lg text-sm border border-blue-100 dark:border-blue-800 flex items-center justify-center gap-2">
              <span>📧</span>
              <span>
                We'll notify <strong>{email}</strong> upon resolution.
              </span>
            </div>
          )}
          ...
          <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg mb-6 border border-gray-200 dark:border-gray-600">
            ...
            <p className="text-xl font-mono font-bold text-green-700 dark:text-green-400 select-all">
              {submittedId}
            </p>
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">
              (Copy this ID to track status)
            </p>
          </div>
          <div className="flex gap-4 justify-center">
            ...
            <button
              ...
              className="text-gray-500 dark:text-gray-400 font-medium hover:text-gray-300"
            >
              Submit Another
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <section className="bg-green-50 dark:bg-gray-800 text-center pt-20 pb-32 px-4 transition-colors duration-300">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 dark:text-white mt-6 mb-6">
            Make Your City{" "}
            <span className="text-green-600 dark:text-green-400">Cleaner</span>,
            Together.
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Spot trash? Don't ignore it. Report it. Join thousands of citizens
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              className="bg-green-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-green-700 transition shadow-lg"
            >
              Report Now 👇
            </button>
            <Link
              to="/tracker"
              className="bg-white dark:bg-gray-700 text-gray-700 dark:text-white px-8 py-3 rounded-lg font-bold hover:bg-gray-50 dark:hover:bg-gray-600 transition shadow border border-gray-200 dark:border-gray-600"
            >
              Track Issue
            </Link>
          </div>
      ...
      <section
        id="report-form"
        className="py-20 px-4 bg-green-50 dark:bg-gray-800 transition-colors duration-300"
      >
        <div className="max-w-4xl mx-auto text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            Fill in the details below to alert our municipal team.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-blue-50 dark:bg-gray-800 dark:text-white rounded-lg border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-green-500 outline-none transition"
                    value={citizenName}
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    We will notify you when it's resolved.
                  </p>
                </div>
                {/* --------------------------------------------- */}
                {/* ----------------------------------- */}
              ...
              <div>
                ...
                <div
                  className={`border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg p-4 h-full flex flex-col justify-center items-center transition ${
                    loading
                      ? "opacity-50"
                ...
                >
                  <input
                    ...
                    disabled={loading}
                    className="file-input file-input-bordered file-input-success w-full max-w-xs mb-3 dark:bg-gray-800 dark:text-white dark:border-gray-700"
                  />
                  {image ? (
                    <img
                      src={image}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-blue-50 dark:bg-gray-800 dark:text-white rounded-lg border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-green-500 outline-none transition h-32 resize-none"
                value={description}
