        ...
        <div className="md:hidden bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 px-2 pt-2 pb-3 space-y-1 shadow-lg">
          ...
          {isAuth ? (
            ...
            <div className="pl-2 space-y-2">
               ...
               <Link to="/signup/user" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300 hover:text-green-600">User Signup</Link>
               <Link to="/signup/admin" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300 hover:text-green-600">Admin Signup</Link>
               
               <p className="text-xs text-gray-400 font-bold uppercase mt-3">Login</p>
               <Link to="/login/user" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300 hover:text-green-600">User Login</Link>
               <Link to="/login/admin" onClick={() => setIsOpen(false)} className="block px-3 py-1 text-sm text-gray-600 dark:text-gray-300 hover:text-green-600">Admin Login</Link>
            </div>
          )}
        </div>
      )}
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <section className="py-12 text-center text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 transition-colors duration-300">
        <p>© 2026 CleanQuest. Building better cities. v2.2</p>
      </section>
    </div>
  );
}
